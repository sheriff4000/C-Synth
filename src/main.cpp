...
// Task that checks when keys are presed
...
void scanOtherBoardsTask(void *pvParameters)
{
  ...
  while (1)
  {
    ...
    while (CAN_CheckRXLevel())
    {
      ...
      // TODO quick descrip of g_note states
      ...
      if (loopPlaying)
      {
        ...
        // TODO: quick descrp (is this for each keyboard)
...
void updateDisplayTask(void *pvParameters)
{
  ...
  while (1)
  {
    ...
    if (keyboardIndex == 0)
    {
      // TODO: should these be atomic (and others below)?
...
void scanKeysTask(void *pvParameters)
{
  ...
  while (1)
  {
    ...
    // TODO: can the mutex be taken + given too?
    xSemaphoreTake(keyArrayMutex, portMAX_DELAY);
